...
3. Click on **Crawlers** under Data Catalog column on the left. 
   ...
   ```
   nycitytaxianalysis-username-crawler
   ```
...
3. Under Job properties, input name as **nycitytaxianalysis-username-yellow**. Since we will be working with only the yellow dataset for this workshop.
   ...
   xi. For Script file name, enter **nycitytaxianalysis-username-yellow**.
